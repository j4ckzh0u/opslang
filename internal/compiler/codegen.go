...
var sdkMapping = map[string]sdkFunc{
	...
	// ── nomad ──────────────────────────────────────────────────────────
	"nomad.job_list":   {pkg: "nomad", goName: "JobList", args: true, params: []string{"s"}},
	"nomad.job_run":    {pkg: "nomad", goName: "JobRun", args: true, params: []string{"s", "s"}},
	"nomad.job_stop":   {pkg: "nomad", goName: "JobStop", args: true, params: []string{"s", "s"}},
	"nomad.alloc_list": {pkg: "nomad", goName: "AllocList", args: true, params: []string{"s", "s"}},
	"nomad.node_list":  {pkg: "nomad", goName: "NodeList", args: true},
	"nomad.node_drain": {pkg: "nomad", goName: "NodeDrain", args: true, params: []string{"s", "b"}},
